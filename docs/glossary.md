...
| ProviderID         | You need to deliver the ProviderID in the endpoints in the calls  as {providerId}. ProviderID represents a particular subscription provider.In order to get the ProviderID, you need to make  GET call to the Subscriptions API |
