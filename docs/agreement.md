...
|----------------------|------------|----------|-----------------------------------------------------------------|------------|
|**amount**      |number(0.00)        |   |*_**Agreement**  amount, which will be displayed on the  **Agreement**  creation screen and on the  **Agreement**  details screen ._*|>= 0.00, decimals separated with a dot.|
...
|**next_payment_date**       |date  | required |_The date of the first scheduled  **Payment Request**. If used, this will be displayed on the  **Agreement**  creation screen and on the  **Agreement**  details screen if first payment date > current date.__|ISO date format: yyyy-MM-dd|
