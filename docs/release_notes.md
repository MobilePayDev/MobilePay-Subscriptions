## In Progress: Subscriptions Integrator 1.1 Release Notes
...
<!-- <div class='post-date'>Highlights</div> -->

#### Add invoice details to subscription 
...
All you need to do is attach an `invoice` object to the property (which is completely optional) of current payment object.
