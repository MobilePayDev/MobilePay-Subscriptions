...
- `notications_on` field was added to [create agreement](agreement#create-agreement-request) request. This field will be honored **only** by MobilePay app starting from **5.0.0 version**.
