...
|**external_id**       |string      |required |*__Agreement__ identifier on the merchant's and integrators side. This will be included in the request body of the success / cancel callback. It is not possible to update the external_id. *||
